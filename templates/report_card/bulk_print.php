...
<body>
  ...
  <div class="toolbar no-print">
    <div class="toolbar-info">
      ...
      <div class="toolbar-meta"><?= htmlspecialchars($term['name'] ?? '') ?> &middot; <?= $classSize ?> Students Formatted for A4 Printing</div>
    </div>
    <div class="toolbar-actions">
      <a href="<?= $base ?>/admin/publish" class="btn btn-outline">Back</a>
    ...
    <div class="container">
      <div class="header-section">
        <div class="school-logo">
          <img src="<?= $base . Config::get('school_logo', '/assets/img/school-logo.png') ?>" alt="Badge" decoding="async" onerror="this.style.visibility='hidden'">
        </div>
        ...
        <div class="student-photo">
          <?php if ($photoSrc): ?>
            <img src="<?= htmlspecialchars($photoSrc) ?>" alt="Student" decoding="async">
          <?php else: ?>
      ...
      <div class="meta-grid">
        <table class="meta-table">
          ...
          <tr>
            ...
            <td class="value"><?= mb_strtoupper(htmlspecialchars(($classInfo['class_name'] ?? '') . ' ' . ($classInfo['section'] ?? ''))) ?></td>
          </tr>
          <tr>
          ...
          <div class="remarks-area">
            <div class="remarks-box">
              ...
              <div style="display:flex; gap:20px; font-weight:700; margin-bottom:5px;">
                <span>Present: <?= $att['days_present'] ?? '0' ?> Days</span>
              ...
              <span class="remarks-content"><?= htmlspecialchars($rem['teacher_remark'] ?? '–') ?></span>
            </div>

            <div class="remarks-box" style="margin-bottom:0;">
              <span class="remarks-title">Headteacher's Comments / Recommendations:</span>
              <span class="remarks-content" style="min-height:40px;"><?= htmlspecialchars($rem['headmaster_remark'] ?? 'Recommended for promotion.') ?></span>
            </div>
          </div>
