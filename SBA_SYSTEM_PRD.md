...
**School:** Uaddara Basic School (Armed Forces Education Unit, Kumasi)**SMS Sender ID:** `Uaddara Bsc`**Version:** 1.1 (Final — Confirmed)**Date:** March 2026**Tech Stack:** Core PHP · MySQL · Tailwind CSS · HTML5 · CSS3 · JavaScript**SMS Gateway:** SMSOnlineGH / Zenoph Notify PHP SDK v2.25.08**Hosting:** Shared Hosting (cPanel / Apache)**Brand Colour:** Rebecca Purple — Primary `#9633cc`
